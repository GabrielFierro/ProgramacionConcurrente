...
class Uno {
    ...
    private static int metodo() {
        ...
        try {
            ...
            valor = valor + Integer.parseInt("ABC");    // Lanza error y se dirige al catch
            valor = valor + 1;
            System.out.println("Valor al fin al del try: " + valor);
        } catch (NumberFormatException e) {
            // Entra al catch
            //valor = valor + Integer.parseInt("ABC");
            System.out.println("Valor al final del catch: " + valor);
            // Como no hay error imprime el resultado de valor que era 1
        } finally {
            // Ejecuta finally incrementando en 1 a la variable valor
